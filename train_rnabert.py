...
def main(args):
    ...
    if args.predict:
        ...
        test_dataset = RNABERTDataset(args.sequences_file, args.intensities_dir, args.htr_selex_dir, args.rbp_num, train=False, max_length=41)
...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(rbp_num=1,
                                ...
                                predict_output_dir='outputs/predictions/RNA_BERT',
                                save_model_file='outputs/models/RNA_BERT.pth',
                                load_model_file='outputs/models/RNA_BERT.pth',
                                batch_size=64,
                                epochs=100,
                                lr=0.001,
                                early_stopping=10,
