...
def main(args):
    ...
    rbp_model = SelectedNGramProjectionModel(args.htr_selex_dir, args.sequences_file, args.intensities_dir, KMer_LEN=(7, 7), top_k=1171, binary_embedding=True, n_jobs=10)
